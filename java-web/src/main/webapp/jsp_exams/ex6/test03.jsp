...
인터페이스와 추상 클래스는 인스턴스를 생성 할 수 없기 때문에 사용할 수 없다.<br>
</p>
...
만약 이 속성이 생략되면 class속성 값을 변수선언하는데 사용한다.<br>
</p>

<h3>score속성</h3>
<p>
객체를 생성 한 후 저장할 보관소를 지정한다.<br>
이 속성을 생략하면 기본적으로 PageContext
</p>
